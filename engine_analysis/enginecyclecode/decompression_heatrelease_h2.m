...
% cell: 203-945-8606
function [Tf,Pf,v0,v2,work,heat]=decompression_heatrelease_h2(P0)
...
[X,Pf,Tf] = equilconstUconstVh2(P0, T0);
...
u1=dot(getu(Tf),X)/WMf;
u2=dot(getu(T2),X)/WMf;
work=(u1-u2)/(1e7); %Joule /gram   (1e7 erg = 1 J)

h2=dot(geth(T2),X)/WMf;
h3=dot(geth(T0),X)/WMf;
