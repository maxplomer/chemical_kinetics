...
PATM=1.01325D6;
Kc=Kp/(RU*T/PATM)^sum(nu(:,I))%Kc from textbook
%6.785996220186934e-004
...
EQINV = exp(G0_SUM);
Kc=1/EQINV
%6.785996220187000e-004

%from ckwyp
smh = cksmh(T, chem);
EG=exp(smh);
Kc = EG(3)*EG(4)/EG(2)/EG(6)
%6.785996220186976e-004
...
%results
%textbook:6.785996220186934e-004
%DWDCT:   6.785996220187000e-004
%CKWYP:   6.785996220186976e-004
