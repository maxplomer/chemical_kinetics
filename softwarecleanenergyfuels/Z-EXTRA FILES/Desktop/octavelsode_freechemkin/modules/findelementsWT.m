function [elementsWT]=findelementsWT
global elements;
elementslist={'H','He', ...
    'Li','Be','B','C','N','O','F','Ne', ...
...
WTlist=[1.00794,4.002602, ...
    ...
    227,232.0381,231.03588,238.0289,237,244,243,247,247,251,252,257,258,259,262]; %units g/mol
%source: http://www.chemicalelements.com/show/mass.html
for i=1:length(elements)
    I_element=find(strcmpi(elementslist,elements{i}));
    elementsWT(i)=WTlist(I_element);
end
