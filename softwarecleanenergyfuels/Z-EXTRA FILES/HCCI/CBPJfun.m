...
%   by Max Plomer
%
function [ Tfuel, Yfuel , t ] = CBPJfun( R , f, T0 )
addpath('chemkin')
...
%T0 = 300;
Phi = 0.3;
%f=40;%rotation frequency,this is a value I will vary, original=100
%R=40;%compression ratio, this is a value I will vary, original=50
...
Yfuel=y(:,14);%send the mass fraction to CBPJ.m
Tfuel=y(:,nT);%send the temp to CBPJ.m
