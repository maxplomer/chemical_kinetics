      program reactor_adiabatic_constV
      EXTERNAL RES, JACDUM
...
C      temperature for ch4 phi=1 temp=900 p0atm=1
C      Y(1:55) = 0.0
C      Y(4) =  2.201489001552540e-01
C      Y(14) = 5.518534952536745e-02
C      Y(48) = 7.246657503193786e-01
C      Y(54) = 1.013250000000000e+06
C      Y(55) = 9.000000000000000e+02
  ...
  10  continue
      ...
      STOP
      end program reactor_adiabatic_constV
      ...
      DOUBLE PRECISION WM, RHO, CVM
C     vectors NEQ long
      DOUBLE PRECISION, dimension(55) :: Y, YDOT, DELTA
C     vectors KK long
     ...
     *   WDOT, YMassfrac, WT
      ...
      DELTA(nT) = YDOT(nT) + (sum(U*WDOT*WT)/RHO)/CVM

      DELTA(nP) = YDOT(nP) - 
     *   (T*RU*sum(YDOT(1:KK)/WT)+(RU/WM)*YDOT(nT))*RHO
