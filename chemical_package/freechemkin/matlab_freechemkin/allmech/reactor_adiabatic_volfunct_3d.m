...
function [ Temp, Yfuel , t ]=reactor_adiabatic_volfunct_3d(R,f,T0)
...
Yfuel=y(:,findsp(fuel_species{1}));%send fuel mass fraction to 3d plot code, if multiple fuels, just send the first fuel
Temp=y(:,nT);%send temp to 3d plot code
